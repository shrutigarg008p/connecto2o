      ...
      <div class="box">
       <div class="box-body">
      	<div class="row">
      	  ...
      	  <div class="col-md-2">
      		<a href="<?php echo base_url();?>admin/qrcodesredirect/add" class="btn btn-primary">Add New</a>
      	  </div>
      	</div>
       </div> 
			 ...
			 <div class="box-body">
				...
				<div class="row">
					...
					<div class="col-md-4">
					<form id="search_form" action="<?php echo base_url().'admin/qrcodesredirect/search';?>" method="get">
					 <label>Search: 
	              ...
	              <thead>
	               ...
	               <tbody>
	                  <?php $class='style="background-color:#f5f5f5"'; $j=$offset;  foreach($result as $rec) {  if($j%2==0) { $class='style="background-color:#ddd"'; } else { $class='style="background-color:#fff"';}  ?>
	                  	<tr <?php echo $class;?>>
	                       <td><?php echo $j;?></td>  
	                      <td><?php echo $rec->key_value;?></td>        
								
								<td><?php echo $rec->redi_url;?></td>
								<!-- <td><?php echo date("d-m-Y", strtotime($rec->created_at));?></td> -->
				                <td align="center"> 
				               		 <a rel="tooltip" class="btn btn-danger"  onclick="return confirm('Are you sure, You want to delete?')" title="Delete"  href="<?php echo base_url();?>admin/qrcodesredirect/delete/<?php echo base64_encode($rec->id);?>"><i class='fa fa-trash-o'></i> Delete</a>
